...
#data= pd.read_csv('veyron.csv')
data= pd.read_csv('sterling.csv') 
#data= pd.read_csv('fresco.csv')
names_data = pd.read_csv('hotelnames.csv')
my_hotel_id= 15627
#hotel_id=[15627,15628,15629,15630,15631,15632,15633,15634   
#my_hotel_id = 16733    #hotel id for veyron
my_hotel_id= 18213 #HOTEL ID FOR STERLING
#hotel_id = [16733, 16734, 16735, 16736, 16737, 16738, 16740, 16741, 16742, 16743] #HOTEL ID FOR VEYRON  
hotel_id=[18213, 22188, 22189, 22190, 22191] #compset for sterling
